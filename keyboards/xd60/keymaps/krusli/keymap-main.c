...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  |------+-----+-----+-----+----+----+----+----+-----+-----+-----+-----+-------+-------+-------|
  |      | VoD | VoU | Mut |    |    | *  | /  | Hom | PgU | Lef | Rig | Enter |       | Reset |
  |------+-----+-----+-----+----+----+----+----+-----+-----+-----+-----+-------+-------+-------|
  |      |     |     |     |    |    | +  | -  | End | PgD | Dow |     |       |       |       |
  |------+-----+-----+-----+----+----+----+----+-----+-----+-----+-----+-------+-------+-------|
 ...
 */
  KEYMAP(
      ...
      KC_CAPS, RGB_TOG, RGB_MOD, RGB_HUI, RGB_VAD, RGB_VAI, RGB_SAD, RGB_SAI, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP,    _______, KC_DEL,             \
      _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, KC_PAST, KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT,  KC_NO,             RESET,    \
      _______, _______, _______, _______, _______, _______, _______, KC_PPLS, KC_PMNS, KC_END,  KC_PGDN, KC_DOWN,  _______, _______,  _______,   \
      _______, _______, _______,                          _______,                              _______, _______,  F(0),    _______,  _______),
};
